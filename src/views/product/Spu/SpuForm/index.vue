    ...
    <el-form ref="form" label-width="80px" :model="spu">
      ...
      <el-form-item label="销售属性">
        ...
        <el-table style="width: 100%;margin-top: 20px;" border :data="spu.spuSaleAttrList">
          ...
          <el-table-column prop="prop" label="属性值名称列" width="width">
            <template slot-scope="{row,$index}">
              ...
              <!-- @click="showInput" -->
              <el-button v-else class="button-new-tag" size="small" @click="addSaleSttrValue(row)">添加</el-button>
            </template>
          </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      attrIdAndAttrName: '',//收集未选中的销售属性id和名字
    }
  },
  methods: {
    // 照片墙删除某一个图片时触发
  ...
  computed: {
    ...
    unSelectSaleAttr() {
      ...
      // 当前SPU拥有的属于直接的销售属性SPU.spuSaleAttrList ----颜色
