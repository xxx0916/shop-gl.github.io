  ...
  <div>
    ...
    <el-card>
      ...
      <div v-show="scene == 0">
        ...
        <el-table style="width: 100%;" border :data="records">
          ...
          <el-table-column prop="col.id" label="操作" width="width">
            <template slot-scope="{row,$index}">
              ...
              <hint-button type="info" icon="el-icon-info" size="mini" title="查看当前类别spu全部sku列表" @click="handler(row)">
              </hint-button>
        ...
        <el-pagination style="text-align:center ;" :current-page="page" :page-sizes="[3, 5, 10]" :page-size="limit"
          layout="prev, pager, next, jumper, sizes,total" @current-change="getSpuList" @size-change="handleSizeChange"
          :total="total">
        </el-pagination>
      </div>
    ...
    <el-dialog :title="`${spu.spuName}的sku列表`" :visible.sync="dialogTableVisible" :before-close="close">
      ...
      <el-table :data="skuList" style="width: 100%;" border v-loading="loading">
        ...
        <el-table-column prop="price" label="价格" width="col.width">
        </el-table-column>
        <el-table-column prop="weight" label="重量" width="col.width">
        </el-table-column>
        <el-table-column  label="默认图片" width="col.width">
          <template slot-scope="{row,$index}">
