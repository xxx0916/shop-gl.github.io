    ...
    <el-form label-width="80px">
      ...
      <el-form-item label="图片列表" size="normal">
        <el-table border :data="spuImageList" @selection-change="handleSelectionChange">
          <el-table-column prop="col.id" type="selection" width="80">
          </el-table-column>
          ...
          <el-table-column prop="imgName" label="名称" width="col.width">
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    //     const [attrId,valueId] = item.attrIdAndValueId
    //     // 携带给服务器参数应该是对象
    //     let obj = {valueId,attrId};
    //     arr.push(obj)
    //   }
    // });
    // 将整理好的参数赋值个skuInfo.skuAttrValueList
